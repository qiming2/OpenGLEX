...
int main()
{
	...
	// -------------------------
	m_Shader shaderGeometryPass("src/9.ssao_geometry.vs", "src/9.ssao_geometry.fs");
	m_Shader shaderLightingPass("src/9.ssao.vs", "src/9.ssao_lighting.fs");
	m_Shader shaderSSAO("src/9.ssao.vs", "src/9.ssao.fs");
